package br.com.ajwebdesign.ui.scrollers {
	...
	public class BackgroundScroll extends CoreEventDispatcher {
		 ...
		 */
		public function BackgroundScroll(target:InteractiveObject, scrollType:String = "enterFrame", maxSpeed:Number = 30,  radius:Number = 0.5, enableZoom:Boolean = false) {
			_target = target;
		...
		private function onMouseDown(e:MouseEvent):void {
			mouseDown = true;
			//var lastPosition:Number = this.position;
		}
